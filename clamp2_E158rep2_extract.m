...
rawDataParentDir='/Volumes/IAND_09/rawData/E158rep2_Tissue/scan';
cd(rawDataParentDir)
extractedDataParentDir='/Users/iandardani/Dropbox (RajLab)/mouse/clamp2_E158rep2/';
%% Variable input
% with sigma=0.4
sigma=0.4;
...
%% call dentist2 for scan1_TumorFreshFrozen_Drug
% navigate to a subregion and run this section to find spots and open GUI for QC steps
...
pause(1)
%% call dentist2 for scan2_TumorFreshFrozen_NoDrug
% navigate to a subregion and run this section to find spots and open GUI for QC steps
